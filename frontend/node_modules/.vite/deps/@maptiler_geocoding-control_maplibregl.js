import {
  require_maplibre_gl
} from "./chunk-L3Z2U7ZS.js";
import {
  __toESM
} from "./chunk-HXA6O6EE.js";

// node_modules/@maptiler/geocoding-control/maplibregl.js
var Li = __toESM(require_maplibre_gl());
var Un = Object.defineProperty;
var wi = (i) => {
  throw TypeError(i);
};
var qn = (i, e, t) => e in i ? Un(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var A = (i, e, t) => qn(i, typeof e != "symbol" ? e + "" : e, t);
var Ei = (i, e, t) => e.has(i) || wi("Cannot " + t);
var oe = (i, e, t) => (Ei(i, e, "read from private field"), t ? t.call(i) : e.get(i));
var kt = (i, e, t) => e.has(i) ? wi("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t);
var gt = (i, e, t, n) => (Ei(i, e, "write to private field"), n ? n.call(i, t) : e.set(i, t), t);
function te() {
}
function Fn(i, e) {
...
var Ot;
function me(i, e) {
  return i === e ? true : (Ot || (Ot = document.createElement("a")), Ot.href = e, i === Ot.href);
}
function jn(i) {
...
function Jn(i, e, { bubbles: t = false, cancelable: n = false } = {}) {
...
function Xe(i, e, t, n, r, u, a = null, o = [-1]) {
  ...
  }) : [], c.update(), E = true, je(c.before_update), c.fragment = n ? n(c.ctx) : false, e.target) {
    if (e.hydrate) {
      const _ = Xn(e.target);
...
function wr(i) {
  ...
  return {
    ...
    o: te,
    d(m) {
      m && J(e), l.d(), f && f.d(), B = false, je(z);
    }
  };
}
var an = typeof devicePixelRatio > "u" ? 1 : devicePixelRatio > 1.25;
var si = an ? "@2x" : "";
var _e = an ? 2 : 1;
var Ne;
var Rt;
...
var Ir = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([6-9][0-9])\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*(EAST|WEST|[EW])?$/i;
var Ci = /^([+-]?[0-8]?[0-9])\s+([0-5]?[0-9]\.\d{3,})[\s,]{1,}([+-]?[0-1]?[0-9]?[0-9])\s+([0-5]?[0-9]\.\d{3,})$/;
var Ni = /^(NORTH|SOUTH|[NS])?[\s]*([+-]?[0-8]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(NORTH|SOUTH|[NS])?[\s]*[,/;]?[\s]*(EAST|WEST|[EW])?[\s]*([+-]?[0-1]?[0-9]?[0-9](?:[\.,]\d{3,}))[\s]*([•º°]?)[\s]*(EAST|WEST|[EW])?$/i;
var ki = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(\.)\s*([0-5]?[0-9])\s*(\.)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(EAST|WEST|[EW])?$/i;
var Oi = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*(D(?:EG)?(?:REES)?)\s*([0-5]?[0-9])\s*(M(?:IN)?(?:UTES)?)\s*((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(S(?:EC)?(?:ONDS)?)\s*(EAST|WEST|[EW])?$/i;
var Ri = /^(NORTH|SOUTH|[NS])?\s*([+-]?[0-8]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|’’|´´|["″”\.])?\s*(NORTH|SOUTH|[NS])?(?:\s*[,/;]\s*|\s*)(EAST|WEST|[EW])?\s*([+-]?[0-1]?[0-9]?[0-9])\s*([•º°\.:]|D(?:EG)?(?:REES)?)?\s*,?([0-5]?[0-9](?:[\.,]\d{1,})?)?\s*(['′´’\.:]|M(?:IN)?(?:UTES)?)?\s*,?((?:[0-5]?[0-9])(?:[\.,]\d{1,3})?)?\s*(''|′′|´´|’’|["″”\.])?\s*(EAST|WEST|[EW])?$/i;
function Ar(i) {
...
function fi(i, e) {
  ...
  let t = null, n = null, r = "", u = "", a = null, o = [], g = false;
  if (Ir.test(i))
...
function Bi(i) {
  ...
  return t = new ln({}), {
    ...
    m(a, o) {
      ee(a, e, o), Ue(t, e, null), n = true, r || (u = he(
        e,
        "click",
        /*click_handler_2*/
        i[78]
    ...
    i(a) {
      n || (ne(t.$$.fragment, a), n = true);
    },
    o(a) {
      ae(t.$$.fragment, a), n = false;
    },
    d(a) {
      a && J(e), qe(t), r = false, u();
    }
  };
}
function Wi(i) {
...
function Hr(i) {
  ...
  return t = new un({}), {
    ...
    m(o, g) {
      ee(o, e, g), Ue(t, e, null), H(e, n), H(e, r), H(r, u), a = true;
    },
    p(o, g) {
    ...
    i(o) {
      a || (ne(t.$$.fragment, o), a = true);
    },
    o(o) {
      ae(t.$$.fragment, o), a = false;
    },
    d(o) {
      o && J(e), qe(t);
    }
...
function Kr(i) {
  ...
  return t = new un({}), g = new ln({}), {
    ...
    m(M, R) {
      ee(M, e, R), Ue(t, e, null), H(e, n), H(e, r), H(r, u), H(e, a), H(e, o), Ue(g, o, null), c = true, E || (_ = he(
        o,
        "click",
        /*click_handler_4*/
        i[80]
    ...
    i(M) {
      c || (ne(t.$$.fragment, M), ne(g.$$.fragment, M), c = true);
    },
    o(M) {
      ae(t.$$.fragment, M), ae(g.$$.fragment, M), c = false;
    },
    d(M) {
      M && J(e), qe(t), qe(g), E = false, _();
    }
  };
}
function Di(i, e) {
  ...
  return n = new Lr({
    ...
    i(g) {
      r || (ne(n.$$.fragment, g), r = true);
    },
    o(g) {
      ae(n.$$.fragment, g), r = false;
    },
    d(g) {
      g && J(t), qe(n, g);
    }
...
function Yr(i) {
  let e, t, n, r, u, a, o, g, c, E, _, M, R, k, I, C, O, x, N, P = false;
  u = new Or({});
  ...
  return ~(k = h(i)) && (I = m[k] = f[k](i)), {
    ...
    m(d, v) {
      ee(d, e, v), ee(d, t, v), H(t, n), H(n, r), Ue(u, r, null), H(n, a), H(n, o), i[72](o), Si(
        ...
        /*searchValue*/
        i[1]
      ), H(n, g), H(n, c), B && B.m(c, null), H(c, E), z && z.m(c, null), H(n, _), W && W.m(n, null), H(n, M), l && l.m(n, null), H(t, R), ~k && m[k].m(t, null), O = true, x || (N = [
        he(
          r,
          "click",
          /*click_handler*/
    ...
    i(d) {
      O || (ne(P), ne(u.$$.fragment, d), ne(B), ne(z), ne(W), ne(l, d), ne(I), O = true);
    },
    o(d) {
      ae(P), ae(u.$$.fragment, d), ae(B), ae(z), ae(W), ae(l, d), ae(I), O = false;
    },
    d(d) {
      d && (J(e), J(t)), qe(u), i[72](null), B && B.d(), z && z.d(), W && W.d(), l && l.d(d), ~k && m[k].d(), x = false, je(N);
    }
  };
}
function Qr(i, e, t) {
  ...
  let { class: c = void 0 } = e, { apiKey: E = void 0 } = e, { bbox: _ = void 0 } = e, { clearButtonTitle: M = "clear" } = e, { clearOnBlur: R = false } = e, { clearListOnPick: k = false } = e, { keepListOpen: I = false } = e, { collapsed: C = false } = e, { country: O = void 0 } = e, { debounceSearch: x = 200 } = e, { enableReverse: N = "never" } = e, { errorMessage: P = "Something went wrong…" } = e, { filter: B = () => true } = e, { flyTo: z = true } = e, { fuzzyMatch: W = true } = e, { language: s = void 0 } = e, { limit: l = void 0 } = e;
  const f = 41415112612;
  let { reverseGeocodingLimit: m = f } = e, { mapController: h = void 0 } = e, { minLength: d = 2 } = e, { noResultsMessage: v = "Oops! Looks like you're trying to predict something that's not quite right. We can't seem to find what you're looking for. Maybe try double-checking your spelling or try a different search term. Keep on typing - we'll do our best to get you where you need to go!" } = e, { placeholder: p = "Search" } = e, { proximity: y = [{ type: "server-geolocation" }] } = e, { reverseActive: b = N === "always" } = e, { reverseButtonTitle: w = "toggle reverse geocoding" } = e, { searchValue: T = "" } = e, { pickedResultStyle: G = "full-geometry" } = e, { showPlaceType: D = "if-needed" } = e, { showResultsWhileTyping: Z = true } = e, { selectFirst: K = true } = e, { flyToSelected: ie = false } = e, { markerOnSelected: j = true } = e, { types: V = void 0 } = e;
  const fe = [];
  let { reverseGeocodingTypes: Ge = fe } = e, { exhaustiveReverseGeocoding: et = false } = e, { excludeTypes: tt = false } = e;
  const ye = void 0;
  ...
  function gi(L, re = true, le = false) {
  ...
  let F, ue, U, mi = "", Me, Y = -1, Re, Ct = [], it, st, ot, Vt, De = false;
  const Ln = /* @__PURE__ */ new Set(), Ze = sn();
  $n(() => {
    h && (h.setEventHandler(void 0), h.indicateReverse(false), h.setSelectedMarker(-1), h.setFeatures(void 0, void 0, false));
  });
  function pi(L) {
    if (t(17, De = false), st && (clearTimeout(st), st = void 0), Y > -1 && F)
      t(14, U = F[Y]), t(1, T = U.place_type[0] === "reverse" ? U.place_name : U.place_name.replace(/,.*/, "")), t(19, Re = void 0), t(64, ue = void 0), t(15, Y = -1);
    else if (T) {
      const re = L || !Kt(T);
      Yt(T, { exact: true }).then(() => {
  ...
  async function Yt(L, { byId: re = false, exact: le = false } = {}) {
    var be, Pe, He;
  ...
  function Sn(L) {
    t(0, b = N === "always"), t(13, F = void 0), t(14, U = void 0), t(15, Y = -1), gi(L[1].toFixed(6) + ", " + Rr(L[0], [-180, 180], true).toFixed(6), false, true);
  }
  function xn(L) {
    if (!F)
      return;
    let re = L.key === "ArrowDown" ? 1 : L.key === "ArrowUp" ? -1 : 0;
    re && (Me.focus(), t(17, De = true), L.preventDefault(), U && Y === -1 && t(15, Y = F.findIndex((le) => le.id === (U == null ? void 0 : U.id))), Y === (U || K ? 0 : -1) && re === -1 && t(15, Y = F.length), t(15, Y += re), Y >= F.length && t(15, Y = -1), Y < 0 && (U || K) && t(15, Y = 0));
  }
  function yi(L, re = true, le = false) {
    if (t(19, Re = void 0), t(14, U = void 0), t(17, De = true), Z || le) {
  ...
  const kn = () => t(17, De = true), On = () => t(17, De = false), Rn = () => t(17, De = true), Pn = () => t(14, U = void 0), In = () => {
  ...
  return i.$$set = (L) => {
    ...
    8192 && G !== "marker-only" && U && !U.address && U.geometry.type === "Point" && U.place_type[0] !== "reverse" && Yt(U.id, { byId: true }).catch((L) => t(19, Re = L)), i.$$.dirty[0] & /*picked*/
...
var ei = Math.ceil;
var xe = Math.floor;
var pe = "[BigNumber Error] ";
var zi = pe + "Number primitive has more than 15 significant digits: ";
var Ce = 1e14;
var q = 14;
var Ui = 9007199254740991;
var ti = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13];
var Ve = 1e7;
var we = 1e9;
function cn(i) {
  var e, t, n, r = x.prototype = { constructor: x, toString: null, valueOf: null }, u = new x(1), a = 20, o = 4, g = -7, c = 21, E = -1e7, _ = 1e7, M = false, R = 1, k = 0, I = {
    prefix: "",
    groupSize: 3,
    ...
    // non-breaking space
    suffix: ""
  }, C = "0123456789abcdefghijklmnopqrstuvwxyz", O = true;
  function x(s, l) {
    ...
    if (l == null) {
      ...
      p = false, b = t(b, l, 10, w.s), (d = b.indexOf(".")) > -1 ? b = b.replace(".", "") : d = b.length;
    }
    ...
    return function(f) {
      ...
      if (f == null ? f = a : se(f, 0, we), v = ei(f / q), M)
        if (crypto.getRandomValues) {
          ...
          throw M = false, Error(pe + "crypto unavailable");
      if (!M)
        for (; y < v; )
  ...
  return r.absoluteValue = r.abs = function() {
    ...
    return h === null ? m ? (l = "Infinity", m < 0 && (l = "-" + l)) : l = "NaN" : (s == null ? l = h <= g || h >= c ? It(Se(f.c), h) : ze(Se(f.c), h, "0") : s === 10 && O ? (f = z(new x(f), a + h + 1, o), l = ze(Se(f.c), f.e, "0")) : (se(s, 2, C.length, "Base"), l = t(ze(Se(f.c), h, "0"), 10, s, m, true)), m < 0 && f.c[0] && (l = "-" + l)), l;
  }, r.valueOf = r.toJSON = function() {
    return W(this);
  }, r._isBigNumber = true, r[Symbol.toStringTag] = "BigNumber", r[Symbol.for("nodejs.util.inspect.custom")] = r.valueOf, i != null && x.set(i), x;
}
function Te(i) {
  var e = i | 0;
...
var Ut = class Et extends es {
  ...
  delete(t) {
    return this.validKey(t) ? this._delete(t) != null : false;
  }
  deleteAll(t) {
    for (const n of t)
      this.delete(n);
...
var dn = (i) => () => i;
var oi = (i) => {
  const e = i ? (t, n) => n.minus(t).abs().isLessThanOrEqualTo(i) : dn(false);
...
var Fe = li();
var vt = (i, e) => i.ll.x.isLessThanOrEqualTo(e.x) && e.x.isLessThanOrEqualTo(i.ur.x) && i.ll.y.isLessThanOrEqualTo(e.y) && e.y.isLessThanOrEqualTo(i.ur.y);
var ui = (i, e) => {
...
var Wt = (i, e) => i.x.times(e.y).minus(i.y.times(e.x));
var gn = (i, e) => i.x.times(e.x).plus(i.y.times(e.y));
var qt = (i) => gn(i, i).sqrt();
var os = (i, e, t) => {
...
var qi = (i, e, t) => e.y.isZero() ? null : { x: i.x.plus(e.x.div(e.y).times(t.minus(i.y))), y: t };
var Fi = (i, e, t) => e.x.isZero() ? null : { x: t, y: i.y.plus(e.y.div(e.x).times(t.minus(i.x))) };
var us = (i, e, t, n) => {
...
var hs = class {
  ...
  run(i, e, t) {
    Lt.type = i;
    const n = [new Hi(e, true)];
    for (let c = 0, E = t.length; c < E; c++)
      n.push(new Hi(t[c], false));
...
var jt = class Gt {
  ...
  static fromRing(e, t, n) {
    ...
    const g = new Ae(r, true), c = new Ae(u, false);
   ...
   */
  split(e) {
    const t = [], n = e.events !== void 0, r = new Ae(e, true), u = new Ae(e, false), a = this.rightSE;
...
var gs = class {
  constructor(i, e) {
    ...
    if (!Array.isArray(i))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new Zi(i[0], this, true), this.bbox = {
      ll: { x: this.exteriorRing.bbox.ll.x, y: this.exteriorRing.bbox.ll.y },
      ur: { x: this.exteriorRing.bbox.ur.x, y: this.exteriorRing.bbox.ur.y }
    }, this.interiorRings = [];
    for (let t = 1, n = i.length; t < n; t++) {
      const r = new Zi(i[t], this, false);
...
var ms = (i, ...e) => Ft.run("union", i, e);
var ps = (i, ...e) => Ft.run("difference", i, e);
Fe.set;
function pn(i, e, t) {
  if (i !== null)
    for (var n, r, u, a, o, g, c, E = 0, _ = 0, M, R = i.type, k = R === "FeatureCollection", I = R === "Feature", C = k ? i.features.length : 1, O = 0; O < C; O++) {
      c = k ? i.features[O].geometry : I ? i.geometry : i, M = c ? c.type === "GeometryCollection" : false, o = M ? c.geometries.length : 1;
      for (var x = 0; x < o; x++) {
        var N = 0, P = 0;
...
function hi(i, e) {
  ...
  for (t = 0; t < I; t++) {
    for (o = R ? i.features[t].geometry : k ? i.geometry : i, c = R ? i.features[t].properties : k ? i.properties : {}, E = R ? i.features[t].bbox : k ? i.bbox : void 0, _ = R ? i.features[t].id : k ? i.id : void 0, g = o ? o.type === "GeometryCollection" : false, a = g ? o.geometries.length : 1, r = 0; r < a; r++) {
...
var yn = vs;
function bs(i, e = {}) {
  if (i.bbox != null && e.recompute !== true)
    return i.bbox;
...
var At = "mtlr-gc-full-geom";
var Qi = "mtlr-gc-full-geom-fill";
var Xi = "mtlr-gc-full-geom-line";
function Ss(i, e, t = true, n = true, r = {}, u = {}, a = Yi) {
  let o;
  const g = [];
  let c, E, _;
  function M() {
  ...
  return {
        ...
        if (n)
          for (const N of C ?? []) {
            ...
            if (n instanceof Function) {
              ...
              P = (typeof n == "object" ? new e.Marker(n) : I(true)).setLngLat(N.center).setPopup(
                new e.Popup({
                  offset: [1, -27],
                  closeButton: false,
                  closeOnMove: true,
    ...
    setSelectedMarker(C) {
      c && c.getElement().classList.toggle("marker-selected", false), c = C > -1 ? g[C] : void 0, c == null || c.getElement().classList.toggle("marker-selected", true);
    },
    getCenterAndZoom() {
      const C = i.getCenter();
...
function xs(i, e, t) {
  ...
  return k = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), {
...
var { MapLibreBasedGeocodingControl: Ts, events: $e } = xs(
  Li.Evented,
  Li
);
...
var ks = $e.SelectEvent;
var Os = $e.FeaturesListedEvent;
var Rs = $e.FeaturesMarkedEvent;
var Ps = $e.OptionsVisibilityChangeEvent;
var Is = $e.PickEvent;
var As = $e.QueryChangeEvent;
var Bs = $e.ResponseEvent;
var Ws = $e.ReverseToggleEvent;
export {
  Os as FeaturesListedEvent,
  Rs as FeaturesMarkedEvent,
  Ns as GeocodingControl,
  Ps as OptionsVisibilityChangeEvent,
  Is as PickEvent,
  As as QueryChangeEvent,
  Bs as ResponseEvent,
  Ws as ReverseToggleEvent,
  ks as SelectEvent,
